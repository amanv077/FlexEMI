...
export default async function BorrowerDashboard() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold tracking-tight text-gray-900">Borrower Dashboard</h1>
        ...
        {upcomingEmis.length === 0 ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {upcomingEmis.slice(0, 3).map((emi: any) => (
              <Card key={emi.id} className="border-l-4 border-l-blue-500">
                ...
                <CardHeader className="bg-gray-50/50 pb-4">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-gray-500">{new Date(loan.startDate).toLocaleDateString()}</span>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs text-gray-500">EMIs Paid</span>
                      </div>
                    </div>
                  </div>
